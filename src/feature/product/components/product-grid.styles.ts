...
export const catalogGridClass =
  'grid gap-3 grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5';

export const catalogCardSizes =
  '(max-width: 640px) 45vw, (max-width: 1280px) 30vw, (max-width: 1536px) 24vw, 21rem';
