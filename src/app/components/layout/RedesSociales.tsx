 ...
 * los iconos de marcas, así que `Facebook` e `Instagram` no existen en ella
 * (el build de Next falla al compilar, aunque en pruebas parezca que va).
 *
 * Son los trazos oficiales de cada marca, a 24×24.
 */
